...
public class PokemonLesson5 {

    private String name = "Missingno";
    private Integer healthPoints = 20;
    private Integer combatPower = 8;

    public PokemonLesson5(String name, Integer healthPoints, Integer combatPower) {
        this.name = name;
    ...
    public static void main(String[] args) {
        PokemonLesson5 pikachu = new PokemonLesson5("Pikachu", 12, 5);
