...
import code.academy.PokemonTrainer;
import code.academy.UserInputUtil;
...
public class MainLesson6 {
    ...
    public static void main(String[] args) {
        ...
        PokemonTrainerLesson6 trainer = new PokemonTrainerLesson6(UserInputUtil.readString());
        ...
        for (Pokemon pokemon : StarterPokemonLesson6.get()) {
            System.out.println(StarterPokemonLesson6.get().indexOf(pokemon) + ". " + pokemon);
        }

        trainer.setStarterPokemon(StarterPokemonLesson6.choosePokemon(UserInputUtil.readInteger()));
     ...
     */
    static void listOwnedPokemon(PokemonTrainerLesson6 trainer) {
        // TODO Week 6
    }
